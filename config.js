...
ConfigData = ' {"FRONT_END_PRIVATE_KEY": \"' + pkey_maker + '\"  , "SIGNUP_SCRIPT_URL" : "' + config.host + '/signup","LOGIN_SCRIPT_URL":"' + config.host + '/login", "CHECK_SESSION_SCRIPT_URL" : "' + config.host + '/checkSession" , "LOGOUT_SCRIPT_URL" : "' + config.host + '/checkSession","UPDATE_SESSION_SCRIPT_URL" : "' + config.host + '/checkSession","SEND_PATENT_SCRIPT_URL" : "' + config.host + '/detector" }';